...
import GroupForm from '@/components/ModalMaster/GroupArisanForm.vue'
...
async function save() {
  if (!formRef.value) return console.error('ref belum terhubung')
  const { valid } = await formRef.value.validate()
  if (!valid) return console.warn('Form tidak valid')
